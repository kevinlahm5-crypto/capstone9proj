...
def lambda_handler(event, context):
    ...
    sns.publish(
        TopicArn=SNS_TOPIC_ARN,
        Subject=f"GuardDuty Incident Contained - Instance {instance_id} Isolated",
        Message=(
            ...
            f"The instance has been moved to a security group with no inbound or outbound rules."
        )
    )
